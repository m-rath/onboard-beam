...
Try setting up Cloud NAT on the subnetwork next time, with only internal ip addresses on workers.
...
pipeline_options = PipelineOptions(
    ...
    # use_public_ips = False,   # THIS IS THE QUESTION -- EXTERNAL CONN WITH INTERNAL ONLY, AND NAT?
